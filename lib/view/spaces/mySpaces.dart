...
import '../finish_work/finish_workout_screen.dart';
...
class _MySpacesState extends State<MySpaces> {
  ...
  List upcomingDeadlines = [
    {"title": "01.08.2023", "subtitle": "Task-5"},
    {"title": "25.07.2023", "subtitle": "Task-4"},
    {"title": "15.07.2023", "subtitle": "Task-1"},
    {"title": "10.07.2023", "subtitle": "Task-2"},
  ];
  ...
  List lastWorkArr = [
    {"project": "Alpha", "task": "Task-1", "time": "10", "progress": 0.5},
    {"project": "Beta", "task": "Task-1", "time": "45", "progress": 0.3},
    {"project": "Alpha", "task": "Task-5", "time": "20", "progress": 0.7},
  ];
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text("My Spaces",style: TextStyle(
                            ...
                            SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: media.width * 0.01),
                                    Column(
                                      children: upcomingDeadlines.map((obj) {
                                        var isLast = obj ==
                                            upcomingDeadlines.last;
                                        return Row(
                ...
                ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: lastWorkArr.length,
                    itemBuilder: (context, index) {
                      var wObj = lastWorkArr[index] as Map? ?? {};
                      return InkWell(
                          onTap: () {
                            Navigator.pushNamed(
                                context, FinishWorkScreen.routeName);
                          },
