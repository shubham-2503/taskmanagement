...
import 'package:Taskapp/view/subscription/upgradePlan.dart';
import 'package:animated_toggle_switch/animated_toggle_switch.dart';
import 'package:Taskapp/utils/app_colors.dart';
import 'package:Taskapp/view/profile/widgets/setting_row.dart';
import 'package:Taskapp/view/profile/widgets/title_subtitle_cell.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: Row(
                          children: [
                            Image.asset("assets/images/renewable-energy.png",
                                height: 15, width: 15, fit: BoxFit.contain,color: AppColors.secondaryColor2,),
                            const SizedBox(
                              width: 15,
                            ),
                            Expanded(
              ...
              SizedBox(height: 25,),
              Center(child: Text('App Version: 1.0.1'))
            ],
          ),
        ),
      ),
