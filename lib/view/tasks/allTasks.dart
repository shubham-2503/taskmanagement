...
class AllTaskScreen extends StatefulWidget {
  ...
  const AllTaskScreen({super.key, required this.refreshCallback});
        ...
        actions: [
          Padding(
            ...
            child: SizedBox(height: 50,width: 150,child:  RoundTextField(
              onChanged: (query) => filterAllTasks(query), hintText: 'Search',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    Task task = filteredAllTasks[index];
